            ...
            children: [
              ...
              Obx(
                () => InputField(
                  ...
                  borderColor: controller.errorMessage == ''
                      ? Colors.grey[200]
              ...
              Obx(
                () => InputField(
                  ...
                  errorText: controller.passworedErrorMessage == ''
                      ? null
                      : controller.passworedErrorMessage,
                  borderColor: controller.passworedErrorMessage == ''
                      ? Colors.grey[200]
                      : Get.theme.primaryColor,
                  ...
                  onChanged: (v) {
                    if (v.length < 8) {
                      controller.passworedErrorMessage =
                          'Le champ Mot de passe doit comporter au moins 8 caractères.';
                    } else {
                      controller.passworedErrorMessage = '';
                    }
                    controller.isTextFieldEmpty();
              ...
              Text(
                "Si vous avez déjà un compte, cliquez ici.".tr,
