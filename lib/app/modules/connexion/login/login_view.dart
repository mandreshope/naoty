          ...
          child: Column(
            children: [
              Container(
                ...
                child: Text("Avez-vous déjà\nun compte ?".tr, style: TextStyle(
              ...
              SizedBox(height: 20,),
              InkWell(
                child: Text("Mot de passe oublié ?".tr, style: TextStyle(
              ...
              Text("Si vous n'avez pas encore de compte, cliquez ici.".tr, style: TextStyle(
                color: Get.theme.primaryColor,
                fontSize: 15
              ),),
              SizedBox(height: 10,),
